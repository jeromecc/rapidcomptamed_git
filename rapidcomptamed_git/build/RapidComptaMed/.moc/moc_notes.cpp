...
void Notes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Notes *_t = static_cast<Notes *>(_o);
        switch (_id) {
        case 0: _t->recordAndClose(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Notes::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Notes::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Notes,
      qt_meta_data_Notes, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Notes::getStaticMetaObject() { return staticMetaObject; }
...
void *Notes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::NotesWidget"))
        return static_cast< Ui::NotesWidget*>(const_cast< Notes*>(this));
